...
export default function Footer() {
  ...
  return (
    <footer className="bg-bark-900 border-t border-white/5 py-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Brand */}
          <div className="text-center md:text-left">
            <p className="font-serif text-xl text-white mb-1">János Tölgyi</p>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="text-white/60 hover:text-terracotta-400 transition-colors text-sm"
              aria-label="Call"
            >
          ...
          <p className="text-white/40 text-sm text-center">
            © {year} János Tölgyi. {t('footer.rights')}
          </p>
        </div>
      </div>
    </footer>
